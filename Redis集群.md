...
```sh
sed -i -e 's/6379/7001/g' -e 's/dir .\//dir \/root\/7001\//g' 7001/redis.conf
sed -i -e 's/6379/7002/g' -e 's/dir .\//dir \/root\/7002\//g' 7002/redis.conf
sed -i -e 's/6379/7003/g' -e 's/dir .\//dir \/root\/7003\//g' 7003/redis.conf
```
...
```sh
# 逐一执行
sed -i '1a replica-announce-ip 192.168.200.137' 7001/redis.conf
sed -i '1a replica-announce-ip 192.168.200.137' 7002/redis.conf
sed -i '1a replica-announce-ip 192.168.200.137' 7003/redis.conf

# 或者一键修改
printf '%s\n' 7001 7002 7003 | xargs -I{} -t sed -i '1a replica-announce-ip 192.168.200.137' {}/redis.conf
```
...
```ini
port 27001
sentinel announce-ip 192.168.200.137
sentinel monitor mymaster 192.168.200.137 7001 2
...
```sh
redis-cli --cluster create --cluster-replicas 1 192.168.200.136:7001 192.168.200.136:7002 192.168.200.136:7003 192.168.200.136:8001 192.168.200.136:8002 192.168.200.136:8003
```
